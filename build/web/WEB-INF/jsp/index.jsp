<!DOCTYPE HTML>
    ...
    <html lang="en">
<head>
    <title>London Baker's & Sweet's</title>
    <meta charset="UTF-8">
...
// LIST OF IMAGES
path[0] = "images/me.jpg";
path[1] = "baked/b7.jpg";
path[2] = "sweets/s2.jpg";
path[3] = "baked/b8.jpg";
path[4] = "sweets/s7.jpg";
path[5] = "sweets/s8.jpg";        
path[6] = "baked/b1.jpg";        
function swapImage()
{
    ...
    <body>
        <div id="header">
             ...
             <div id="menu">
                ...
                <li><a href="multicontroller/mb3.htm">Show</a></li>
