<!DOCTYPE HTML>
    ...
    <html lang="en">
<head>
    <title>The London Bakery & Sweets</title>
    <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, minimumscale=
1.0, maximum-scale=1.0" />
    <link rel="stylesheet" type="text/css" href="bitem1.css"/>
	...
	<div id="c1">
<img height="500" src="sweets/s1.jpg" width="100%" />

	</div>
				
	<div id="c2">			
<p><b><u>Blackberry Fool</u></b></p>	 
<p><b>Price:$12.99	</b></p>
<p><b>Net Weight:12 oz	</b></p>
<p><b>ingredients:</b></p>
...
<table>
<br><p1><u><b><i>Nutrition Per serving </i></u></b></p1></i></u></b>
<tr>
<th>Calories</th>
...
<br>
<div id="buyitem">
                <form action="multicontroller/mb1.htm" >
                <!--<form action="AddServlet" >-->
               No of item: <input type="text" name="" style="height: 40px;width: 120px"  />
               <!--<input type="submit" value="Order" onclick="location.href='multicontroller/mb2.htm';" style="background-color:crimson;font-size: 20px;width: 80px ; color: black; border: 2px solid #336600;padding: 3px "/>-->
               <input type="submit" value="Order" style="background-color:crimson;font-size: 20px;width: 80px ; color: black; border: 2px solid #336600;padding: 3px "/>
               <!--<input type="hidden" value="blackberry_fool" name="item" />-->
